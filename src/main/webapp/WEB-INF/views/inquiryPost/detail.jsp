			    ...
			    <div class="row">
                   <div class="col-10">
	                   <c:if test="${boardPostVO.parentPostNo != 0}">
	                   	  <div class="mt-3">
	                   	  	 <a href="/oho/inquiryPost/detail?boardNo=${boardPostVO.parentPostNo}">원문 보기</a>
	                   	  </div>
	                   </c:if>
	                   ...
	                   <a class="badge bg-secondary text-decoration-none link-light" href="javascript:void(0);">${boardPostVO.inquiryPostVO.inqWriter}</a>
                   </div>
...
<script>
function submitPostForm(boardNo) {
