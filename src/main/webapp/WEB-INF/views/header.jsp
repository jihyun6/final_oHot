    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <!-- 로그인 버튼 -->
          <li>
          	<a class="btn-getstarted" href="javascript:void(0)" onclick="redirectToLogin()"><spring:message code="signin" /></a>
          </li>
          </sec:authorize>
          <!-- 비회원에게 보여짐 끝 -->
		  ...
		  <li class="dropdown">
              ...
              <li><a href="javascript:void(0)"><spring:message code="settings" /></a></li>
            </ul>
		  </li>
